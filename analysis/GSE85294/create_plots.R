...
cs_results_id  <- "syn12063800"
mcp_results_id <- "syn12063802"
...
png('GSE85294_mcpcounter_genes_heatmap.png', width = 800, height = 1000)
pheatmap(
    mcp_zscore_matrix,
    main = "MCPCounter GSE85294",
...
png('GSE85294_mcpcounter_genes_rows_clustered_heatmap.png', width = 800, height = 1000)
pheatmap(
    mcp_zscore_matrix,
    main = "MCPCounter GSE85294",
    annotation_row = mcp_heatmap_row_df,
...
png('GSE85294_cibersort_genes_heatmap.png', width = 800, height = 3000)
pheatmap(
    cs_zscore_matrix,
    main = "Cibersort GSE85294",
    annotation_col = heatmap_col_df,
    scale = "none",
    fontsize = 15,
    fontsize_row = 5)
...
png('GSE85294_cibersort_facet_scatterplot.png', height = 1000)
ggplot(cs_result_df, aes(x = cibersort_cell_type, y = predicted_fraction)) +
    ...
    ggtitle("Cibersort GSE85294")
dev.off()

png('GSE85294_mcpcounter_facet_scatterplot.png', height = 1000)
...
png('GSE85294_PCA.png', width = 800, height = 800)
autoplot(
    prcomp(pca_matrix), 
    data = anno_df, 
    shape = "cell_type", 
