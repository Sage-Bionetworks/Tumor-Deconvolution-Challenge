...
## Rscript ./run-cibersortx-on-rerun-validation.R --token=c615ba7853a9c42acd63b1aaf2231c1a --username=brian.white@sagebase.org
...
## Rscript ./run-cibersortx-on-rerun-validation.R --token=c615ba7853a9c42acd63b1aaf2231c1a --username=brian.white@sagebase.org
##   --input-file-synId=syn21753454 --input-folder-synId=syn21647466 --output-folder-synId=syn22331159 --prefix=in-silico
