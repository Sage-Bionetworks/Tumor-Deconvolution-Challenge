...
l_ply(subchallenges,
      .fun = function(subchallenge) {
          ...
          png(paste0("rerun-validation-bootstrap-pearson-vs-round-", subchallenge, ".png"))
          print(g)
          d <- dev.off()
      })
...
png(paste0("rerun-validation-bootstrap-pearson-vs-round-", "all", postfix, ".png"), width = 2 * 480)                    
