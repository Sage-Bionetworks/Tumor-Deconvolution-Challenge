...
fcs <- connection$getDataset("fcs_analyzed_result")
hai <- connection$getDataset("hai")
...
#     used = list(),
#     executed = list("https://github.com/Sage-Bionetworks/Tumor-Deconvolution-Challenge/blob/master/analysis/SDY364/create_processed_tables.R")
# )
# 
