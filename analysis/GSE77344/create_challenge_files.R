...
gt.df <- gses %>%
  ...
  dplyr::select(
        "sample", 
        "cd4_t" = "cell prop. cd4 t lymphocyte:ch1",
        "cd8_t" = "cell prop. cd8 t lymphocyte:ch1", 
        "granulocyte" = "cell prop. granulocyte:ch1",
        "monocyte" = "cell prop. monocyte:ch1",
        "nk_cell" = "cell prop. nk lymphocyte:ch1") %>%
  dplyr::select(c(sample, cd4_t, cd8_t, monocyte, nk_cell)) %>%
  melt(id.vars = "sample") %>%
