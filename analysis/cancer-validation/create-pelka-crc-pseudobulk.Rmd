...
# NB: outputs
# counts.ensg: ensg counts cluster-level pseudo-bulk 
# counts.sym: sym counts cluster-level pseudo-bulk
...
fine.cell.trans <- list(
  ...
  "cTNI26 (ILC3)" = "ILC3",
  "Tumor cE01 (Stem/TA-like)" = "cancer",
  "Tumor cE02 (Stem/TA-like/Immature Goblet)" = "cancer",
  "Tumor cE03 (Stem/TA-like prolif)" = "cancer",
  "Tumor cE04 (Enterocyte 1)" = "cancer",
  "Tumor cE05 (Enterocyte 2)" = "cancer",
  "Tumor cE06 (Immature Goblet)" = "cancer",
  "Tumor cE07 (Goblet/Enterocyte)" = "cancer",
  "Tumor cE08 (Goblet)" = "cancer",
  "Tumor cE09 (Best4)" = "cancer",
  "Tumor cE10 (Tuft)" = "cancer",
  "Tumor cE11 (Enteroendocrine)" = "cancer"
)
          ...
          llply(subsets,
                .fun = function(cell.type.subset) {
                  ...
                  if(cell.type.subset == "only.challenge.types") {
                    tmp.metadata <- tmp.metadata[tmp.metadata[, cell.type.col] %in% c("cancer", coarse_cell_types, fine_cell_types),]
                  }
  ...
  for(cell.type.subset in subsets) {
    ...
    expr.mat.files[[grain]][[cell.type.subset]] <- 
      list("hugo-cpm" = paste0("pelka-", grain, "-hugo-cpm-expr-", cell.type.subset, ".csv"),
           ...
           "ensg-cnts" = paste0("pelka-", grain, "-ensg-raw-expr-", cell.type.subset, ".csv")
      )
