...
cs_results_id  <- "syn12063821"
mcp_results_id <- "syn12063822"
...
png('GSE89134_mcpcounter_genes_heatmap.png', width = 800, height = 1000)
pheatmap(
    mcp_zscore_matrix,
    main = "MCPCounter GSE89134",
...
png('GSE89134_mcpcounter_genes_rows_clustered_heatmap.png', width = 800, height = 1000)
pheatmap(
    mcp_zscore_matrix,
    main = "MCPCounter GSE89134",
    annotation_row = mcp_heatmap_row_df,
...
png('GSE89134_cibersort_genes_heatmap.png', width = 800, height = 3000)
pheatmap(
    cs_zscore_matrix,
    main = "Cibersort GSE89134",
    annotation_col = heatmap_col_df,
    scale = "none",
    fontsize = 15,
    fontsize_row = 5)
...
png('GSE89134_cibersort_facet_scatterplot.png', height = 1000)
ggplot(cs_result_df, aes(x = cibersort_cell_type, y = predicted_fraction)) +
    ...
    ggtitle("Cibersort GSE89134")
dev.off()

png('GSE89134_mcpcounter_facet_scatterplot.png', height = 1000)
...
png('GSE89134_PCA.png', width = 800, height = 800)
autoplot(
    prcomp(pca_matrix), 
    data = anno_df, 
    shape = "cell_type", 
