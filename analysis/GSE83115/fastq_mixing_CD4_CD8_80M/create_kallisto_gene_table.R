...
write_tsv(tpm_df, "kallisto_gene_tpms.tsv")
...
activity_obj = Activity(
    ...
    executed = "https://github.com/Sage-Bionetworks/Tumor-Deconvolution-Challenge/blob/master/analysis/GSE83115/fastq_mixing_CD4_CD8_80M/create_kallisto_gene_table.R"
)
