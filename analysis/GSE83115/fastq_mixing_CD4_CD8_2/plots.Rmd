...
mcp_ssgsea_df <- gsva(tpm_m, mcp_genes, rnaseq = FALSE, method = "ssgsea", verbose = F) %>%
    ...
    gather(key = "sample", value = "enrichment", CD4_CD8_0.005_rep_1:CD4_CD8_0_rep_9) %>%
    left_join(sample_df)
...
pval_df <- data_frame(
    "CD8_Fraction" = c(0.005, 0.01, 0.02, 0.05),
...
cs_results_id  <- "syn12385636"
mcp_results_id <- "syn12385637"
