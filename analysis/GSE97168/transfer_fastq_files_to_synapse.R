...
# tmp_dir   <- "/home/aelamb/tmp/tumor_deconvolution/GSE97168/"
...
activity_obj <- Activity(
    ...
    executed = list("https://github.com/Sage-Bionetworks/Tumor-Deconvolution-Challenge/blob/master/analysis/GSE97168/transfer_fastq_files_to_synapse.R")
)
