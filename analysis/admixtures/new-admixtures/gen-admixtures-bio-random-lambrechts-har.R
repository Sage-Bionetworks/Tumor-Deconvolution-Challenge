...
broken.stick.admixtures.unconstrained.zero <- zero.out.populations(broken.stick.admixtures.unconstrained)
broken.stick.admixtures.zero <- zero.out.populations(broken.stick.admixtures)
