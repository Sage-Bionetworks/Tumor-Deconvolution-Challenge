...
broken.stick.admixtures.zero <- t(find.extremal.points.across.matrices(mats, m = 4*length(pops.to.zero.out)))
...
broken.stick.admixtures.unconstrained.zero <- t(find.extremal.points.across.matrices(mats, m = 4*length(pops.to.zero.out)))
