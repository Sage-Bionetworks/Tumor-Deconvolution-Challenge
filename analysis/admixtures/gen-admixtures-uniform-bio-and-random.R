...
writeData(wb, sheet = 3, broken.stick.admixtures.unconstrained, colNames = TRUE, rowNames = FALSE)
saveWorkbook(wb, paste0(date.prefix, "-admixtures.xlsx"), overwrite = TRUE)

prefix <- paste0(date.prefix, "-biological")
...
prefix <- paste0(date.prefix, "-random")
file <- paste0(prefix, "-cell-type-correlations.png")
png(file)
